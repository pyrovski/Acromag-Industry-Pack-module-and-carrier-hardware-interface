...
/*  Slot A IO space addr. offset from carrier base addr. */
#define SLOT_A_IO_OFFSET	 0x0180
/*  Slot A ID space addr. offset from carrier base addr. */
#define SLOT_A_ID_OFFSET	 0x0040
/*  Slot A MEM space addr. */
#define SLOT_A_MEM_OFFSET	 0x0
/*  Slot B IO space addr. offset from carrier base addr. */
#define SLOT_B_IO_OFFSET	 0x0200
/*  Slot B ID space addr. offset from carrier base addr. */
#define SLOT_B_ID_OFFSET	 0x0080
	/*  Slot B MEM space addr. */
#define SLOT_B_MEM_OFFSET	 0x00800000
/*  Slot C IO space addr. offset from carrier base addr. */
#define SLOT_C_IO_OFFSET	 0x0280
/*  Slot C ID space addr. offset from carrier base addr. */
#define SLOT_C_ID_OFFSET	 0x00C0
/*  Slot C MEM space addr. */
#define SLOT_C_MEM_OFFSET	 0x01000000
/*  Slot D IO space addr. offset from carrier base addr. */
#define SLOT_D_IO_OFFSET	 0x0300
/*  Slot D ID space addr. offset from carrier base addr. */
#define SLOT_D_ID_OFFSET	 0x0100
/*  Slot D MEM space addr. */
#define SLOT_D_MEM_OFFSET	 0x01800000
/*  Slot E IO space addr. offset from carrier base addr. */
#define SLOT_E_IO_OFFSET	 0x0380
/*  Slot E ID space addr. offset from carrier base addr. */
#define SLOT_E_ID_OFFSET	 0x0140
/*  Slot E MEM space addr. */
#define SLOT_E_MEM_OFFSET	 0x02000000
