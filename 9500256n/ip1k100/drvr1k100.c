...
/*
{+D}
    SYSTEM:         Software for IP1k100

    FILENAME:       drvr1k100.c
    ...
    ABSTRACT:       This module is the main routine for the example program
                    which demonstrates how the IP1k100 Library is used.
...
{+D}
    ...
    MODULE NAME:    scfg1k100 - set configuration block contents.
...
{+D}
    ...
    MODULE NAME:    psts1k100 - print board status information
...
*/
    ...
    while(!finished)
    {
	rsts1k100(c_blk); /* get board's status info into structure */
