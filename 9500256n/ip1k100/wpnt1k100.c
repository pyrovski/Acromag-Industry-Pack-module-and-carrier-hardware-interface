...
{+D}
    ...
    FILENAME:           wpnt1k100.c
        
    MODULE NAME:        wpnt1k100() - write output point
    ...
    CALLING SEQUENCE:   status = wpnt1k100(ptr, port, point, value);
                          where:
                            status (long)
...
long wpnt1k100(c_blk, port, point, value)
