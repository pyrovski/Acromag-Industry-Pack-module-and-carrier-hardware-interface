...
{+D}
    ...
    FILENAME:       cnfg1k110.c

    MODULE NAME:    cnfg1k110 - configure 1k110 board
    ...
    ABSTRACT:	    This module is used to perform the configure function
                    for the IP1k110 board.

    CALLING
	SEQUENCE:	    cnfg1k110(ptr);
...
/*
    ...
    for the IP1k110 board.  A pointer to the Configuration Block will
